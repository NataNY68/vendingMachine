...
import static com.techtorial.Products.*;
...
public class WelcomePage {
    ...
    public static void main(String[] args) {
        ...
        getInstructions(allOptions);
            ...
            option = getIntegerInput(scanner, new Integer[]{1, 2, 3, 4, 5, 6, 7, 8});
            switch (option) {
                /*
                ...
                case 4:
                    ...
                    System.out.println(getProductPrice(answer));
                    break;
                case 5:
                    Products.getAllPrices();
                    break;
                case 6:
                    System.out.println("Enter your min and max prices");
